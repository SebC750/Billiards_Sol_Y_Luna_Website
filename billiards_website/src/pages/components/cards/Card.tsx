        ...
        <>
            <div className="rounded-md flex flex-col flex-grow bg-transparent shadow-xl border-b-4 border-yellow-400 w-full mb-4 md:pb-0">
                {"imageFile" in props.cardProps ? (
                    <figure>
                        <img src={props.cardProps.imageFile} loading="lazy" alt={props.cardProps.altTitle} className="transition-all h-72 object-cover w-full rounded-t-md cursor-pointer hover:p-2" />
                    </figure>
                ) : null}
