            ...
            <header>
                <nav className={`${scrolled || !props.isHomepage ? 'bg-black shadow-xl' : 'bg-transparent shadow-none'} flex flex-col md:flex-row justify-start items-center fixed top-0 p-2 w-full transition-all duration-250 z-10`}>
                    <div className="flex items-center p-2">
                        <h1 className="cursor-pointer text-xl sm:text-xl md:text-2xl pl-4"> <a href="/" className="flex items-center gap-2 font-fascinate no-underline ml-2 transition-all text-yellow-400 mr-4 hover:text-3xl"> <img src="images/sunandmoon.webp" width="50" height="50" alt="billiards sol y luna logo"/> Billiards Sol y Luna </a></h1>
                    </div>
